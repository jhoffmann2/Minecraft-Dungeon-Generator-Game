...
scoreboard players tag @e[name=block7Memory] add evocationIllagerMonsterSpawnerInSlot0
...
scoreboard players set s1Probability controls 2
scoreboard players set s2Probability controls 1
