...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot0] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot0] slot.hotbar.0 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot1] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot1] slot.hotbar.1 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot2] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot2] slot.hotbar.2 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot3] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot3] slot.hotbar.3 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot4] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot4] slot.hotbar.4 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot5] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot5] slot.hotbar.5 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot6] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot6] slot.hotbar.6 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot7] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot7] slot.hotbar.7 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
...
execute @a[m=!3,tag=TotemOfMining] ~ ~ ~ execute @a[m=!3,tag=!MiningPickInSlot8] ~ ~ ~ replaceitem entity @s[tag=IronPickInSlot8] slot.hotbar.8 minecraft:iron_pickaxe 1 0 {CanDestroy:["minecraft:stonebrick","minecraft:emerald_ore","minecraft:diamond_ore","minecraft:lapis_ore","minecraft:coal_ore","minecraft:iron_ore","minecraft:gold_ore"]}
